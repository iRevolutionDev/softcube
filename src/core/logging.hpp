...
#define SC_LOG_WARN(...)     SC_LOG_GROUP_WARN(get_log_group(), __VA_ARGS__)
#define SC_LOG_ERROR(...)    SC_LOG_GROUP_ERROR(get_log_group(), __VA_ARGS__)
#define SC_LOG_CRITICAL(...) SC_LOG_GROUP_CRITICAL(get_log_group(), __VA_ARGS__)
